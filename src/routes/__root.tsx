...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,600&family=Space+Grotesk:wght@500;600;700&family=Inter:wght@500;600;700;800;900&family=Lobster+Two:ital,wght@1,700&family=Poppins:wght@400;500;600;700&family=Permanent+Marker&family=Barlow+Condensed:wght@600;700&display=swap",
      },
